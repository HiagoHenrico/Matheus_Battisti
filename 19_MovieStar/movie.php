<?php 
    ...
    // Checar se o filme pertence ao usuario
    $userOwnsMovie = false;
    ...
    <div id="main-container" class="container-fluid">
        <div class="row">
            ...
            <div class="offset-md-1 col-md-10" id="reviews-container">
                <h1 id="reviews-title">Avaliações: </h1>
                <!-- Verifica se habilita a review para o usuario ou não -->
                <?php if(!empty($userData) && !$userOwnsMovie && !$alreadyReviewed): ?>
                <div class="col-md-12" id="review-form-container">
                    <h4>Envie sua avaliação</h4>
                    <p class="page-description">Preencha o formulario com a nota e o comentário sobre o filme</p>
