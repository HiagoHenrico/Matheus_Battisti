    ...
    <div class="col-md-12">
        <div class="row">
            <div class="col-md-6 offset-md-1">
                ...
                <form action="<?= $BASE_URL ?>movie_process.php" id="edit-movie-form" method="POST" enctype="multpart/form-data">
                ...
                <input type="hidden" name="id" value="<?= $movie->id ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="lenght" id="lenght" placeholder="Digite a duração do filme" value="<?= $movie->lenght ?>">
                    </div>
                    <div class="form-group">
                        ...
                        <option value="Fantasia / Ficção" <?= $movie->category === "Fantasia" ? "selected" : ""?>>Fantasia / Ficção</option>
